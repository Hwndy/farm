...
const VerifyEmail = () => {
  ...
  const handleVerify = async () => {
    ...
    setMessage('');
    try {
      const response = await axios.post('https://farmera-abl8.onrender.com/api/v1/auth/verify-otp', { 
        email, 
        otp 
      });
  ...
  const handleResendOtp = async () => {
    ...
    setError('');
    try {
      await axios.post('https://farmera-abl8.onrender.com/api/v1/auth/resend-otp', { email });
